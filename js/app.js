...
(function(){ 
    ...
    showTotals = () =>{
        ...
        const totalMoney = total.reduce(function(total, items){
            total += items;
            return total;
        }, 0); //this is a reduce method used to basically reduce the selected target with a given paremeters of the total and the item to which we want to reduce
